...
Route::middleware('auth:sanctum')->group(function(){
    ...
    Route::get('/projects/{project}/service-entries',[ServiceEntryController::class,'index']); Route::post('/projects/{project}/service-entries',[ServiceEntryController::class,'store']); Route::apiResource('service-entries',ServiceEntryController::class)->except(['index','store']);
